...
#include "SVON_AITask_MoveTo.generated.h"
...
UCLASS()
class UESVON_API USVON_AITask_MoveTo : public UAITask
{
	GENERATED_BODY()

public:
	USVON_AITask_MoveTo(const FObjectInitializer& ObjectInitializer);
	...
	UFUNCTION(BlueprintCallable, Category = "AI|Tasks", meta = (AdvancedDisplay = "AcceptanceRadius,StopOnOverlap,AcceptPartialPath,bUsePathfinding,bUseContinuosGoalTracking", DefaultToSelf = "Controller", BlueprintInternalUseOnly = "TRUE", DisplayName = "Move To Location or Actor"))
		static USVON_AITask_MoveTo* AIMoveTo(AAIController* Controller, FVector GoalLocation, AActor* GoalActor = nullptr,
